...
2 exercises on how a CPU talks to memory: splitting a logical address into a page number and offset by hand, and mapping a file directly into memory instead of reading it byte by byte.
